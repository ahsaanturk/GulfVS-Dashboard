    ...
    <div className="space-y-8 md:space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-12">
      <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
            <button onClick={onAddCompany} className="px-6 md:px-8 py-3 md:py-4 bg-primary text-white rounded-2xl font-black text-[10px] md:text-xs uppercase tracking-widest shadow-2xl shadow-primary/20 hover:scale-105 active:scale-95 transition-all text-center">Target +</button>
            <button onClick={onAddLog} className="px-6 md:px-8 py-3 md:py-4 bg-accent text-white rounded-2xl font-black text-[10px] md:text-xs uppercase tracking-widest shadow-2xl shadow-accent/40 hover:scale-105 active:scale-95 transition-all text-center">Reach +</button>
        </div>
      </header>
